namespace Gu.Wpf.FlipView.Gestures
{
    ...
    public interface IGestureInterpreter
    {
        ...
        bool TryGetGesture(IReadOnlyList<GesturePoint> points, [NotNullWhen(true)] out GestureEventArgs? gestureEventArgs);
        ...
        bool TryGetGesture(ExecutedRoutedEventArgs executed, [NotNullWhen(true)] out GestureEventArgs? gestureEventArgs);
    }
}
